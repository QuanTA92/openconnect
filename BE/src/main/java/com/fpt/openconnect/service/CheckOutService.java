...
public class CheckOutService {
    ...
    public static String createOrder(OrdersEntity orders, String urlReturn) {
...
//       Value Amount
        vnp_Params.put("vnp_Amount", String.valueOf(orders.getPrice()*100));
        vnp_Params.put("vnp_CurrCode", "VND");

        vnp_Params.put("vnp_TxnRef", vnp_TxnRef);
        // customer information
        vnp_Params.put("vnp_OrderInfo", orders.getUser().getUsername());
